...
Обфускация - это раздел криптографии, который изучает методы и принципы затруднения или не возможности статического анализа,усложение динамического анализа.
...
opaque predicate (непрозрачный предикат) - это предикат семантика которого является не тривиальной и сложной или даже не возможной при статическом анализе и затрудняющем сильно динамический анализ.
