...
Обфускация - это раздел криптографии который изучает методы и принципы затруднения или не возможности статического анализа и динамического анализа.
...
Я рассмотрю в этой статье 2 подраздела обфускации (науки),а именно непрозрачные предикаты.
...
opaque predicate - это самый сложный вид CFG обфускации при разработке и при анализе и оценки семантики обфусцированной этой технологией программы.
